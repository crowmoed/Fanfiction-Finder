  ...
  return (
    <div className="stack" style={{ gap: "1.5rem" }}>
      <header className="stack" style={{ gap: "0.25rem" }}>
        <h1 style={{ margin: 0 }}>Result states</h1>
      ...
      <section className="stack">
        <h2 style={{ fontSize: "1rem", margin: 0 }}>High score, full fields</h2>
        <FicCard fic={SAMPLE_FICS[0]} />
      </section>

      <section className="stack">
        <h2 style={{ fontSize: "1rem", margin: 0 }}>Mid score</h2>
        <FicCard fic={SAMPLE_FICS[1]} />
      </section>

      <section className="stack">
        <h2 style={{ fontSize: "1rem", margin: 0 }}>
          Unranked (null score) + missing optional fields
        </h2>
      ...
      <section className="stack">
        <h2 style={{ fontSize: "1rem", margin: 0 }}>
          Match highlighting — query: “{DEMO_QUERY}”
        </h2>
        <p className="muted" style={{ margin: 0 }}>
